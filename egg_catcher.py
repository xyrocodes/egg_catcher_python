...
win = Tk()
c = Canvas(win , width = canvas_width ,  height = canvas_height , background = 'grey')
c.create_rectangle(-5, canvas_height - 100 , canvas_width + 5 , canvas_height + 5 , fill='red', width=0)
c.create_oval(-80,-80,120,120,fill='yellow' , width=0)
c.pack()

color_cycle = cycle(['light pink' , 'light blue' , 'light yellow','light green' , 'red', 'blue' , 'green','black'])
egg_width = 45
egg_height = 55
egg_score = 10
egg_speed = 500
